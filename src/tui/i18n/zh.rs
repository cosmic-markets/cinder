...
pub static CN: Strings = Strings {
    ...
    twap: "TWAP",
    twap_order: "配置 TWAP",
    twap_modal_title: "新建 TWAP",
    twap_modal_intro: "每片为市价单。节奏：每分钟 1 片。",
    twap_field_market: "市场",
    twap_field_side: "方向",
    twap_field_size: "总量",
    twap_field_total_time: "总时长",
    twap_field_hours: "小时",
    twap_field_mins: "分钟",
    twap_unit_hr: "时",
    twap_unit_min: "分钟",
    twap_unit_slices: "片",
    twap_nav_field: "选择字段",
    twap_toggle_side: "切换方向",
    twap_cycle_market: "切换市场",
    twap_start: "开始",
    twap_summary_prefix: "将触发",
    twap_summary_slices_of: "次市价分片，总量",
    twap_summary_per_slice_suf: "/片",
    twap_summary_interval_suf: "间隔",
    twap_summary_placeholder: "—",
    twap_err_size: "数量必须为正数",
    twap_err_duration: "总时长必须为正",
    twap_err_too_short: "总时长至少为 1 分钟",
    ...
    bots_title: "机器人",
    bots_empty: "没有运行中的机器人 \u{2014} 按 [t] 切到 TWAP，再按 [Enter] 配置",
    bots_kind: "类型",
    bots_progress: "进度",
    bots_interval: "间隔",
    bots_next: "下一片",
    bots_state: "状态",
    bots_pause_resume: "暂停/继续",
    bots_stop: "停止",
    bots_restart: "重启",
    bots_remove: "移除",
    bots_status_running: "运行中",
    bots_status_paused: "已暂停",
    bots_status_stopped: "已停止",
    bots_status_completed: "已完成",
    bots_paused_status: "TWAP 已暂停",
    bots_resumed_status: "TWAP 已继续",
    bots_stopped_status: "TWAP 已停止",
    bots_restarted_status: "TWAP 已重启",
    bots_removed_status: "TWAP 已移除",
    twap_waiting_market_cfg: "等待市场配置",
    twap_waiting_trader_sync: "等待交易者状态同步",
    twap_waiting_active_market: "切换到此市场以继续分片",
    twap_waiting_wallet: "钱包已断开 \u{2014} 机器人已停止",
    twap_waiting_authority: "已连接其他钱包 \u{2014} 机器人不会触发",
    twap_restart_wallet_mismatch: "重启被拒绝：此机器人由其他钱包创建",
    twap_slice_confirmed: "分片已确认",
    twap_slice_failed: "分片失败",
    twap_slice_unconfirmed: "分片已广播（确认未知）",
    twap_confirm_start: "启动 TWAP？[Y/N]",
    twap_confirm_restart: "重启将再次发送所有分片。继续？[Y/N]",
    twap_confirm_stop: "停止机器人？未发送的分片将不会执行。[Y/N]",
    twap_confirm_remove: "从列表中移除机器人？[Y/N]",
};
